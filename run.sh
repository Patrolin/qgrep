...
clang c99/main.c -march=native -masm=intel -std=gnu99 -nostdlib -fno-stack-protector -Werror -Wconversion -Wnullable-to-nonnull-conversion -fno-signed-char -O0 -g -o foo-linux-x64 && ./foo-linux-x64
