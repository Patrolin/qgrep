...
clang c99/main.c -Wno-gcc-compat -march=native -masm=intel -std=gnu99 -D HAS_CRT -fno-stack-protector -Werror -Wconversion -fno-signed-char -O0 -g -o foo-linux-x64 && ./foo-linux-x64
